        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-400 leading-relaxed mb-12 font-medium">
              NexusHR is a high-performance operating system designed for the complexities of the modern global enterprise. We've replaced legacy friction with precision-engineered automation.
            </p>
