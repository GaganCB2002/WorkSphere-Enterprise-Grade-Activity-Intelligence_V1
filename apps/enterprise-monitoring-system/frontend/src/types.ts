export type Role = 'CEO' | 'HR' | 'Manager' | 'MANAGER' | 'Lead' | 'LEAD' | 'Employee' | 'EMPLOYEE' | 'TECH_LEAD' | 'Marketing' | 'MARKETING' | 'ADMIN' | 'SUPERADMIN' | 'IT' | 'SUPPORT' | 'STAFF' | 'INTERN' | 'Intern' | 'FINANCE_MANAGER'
