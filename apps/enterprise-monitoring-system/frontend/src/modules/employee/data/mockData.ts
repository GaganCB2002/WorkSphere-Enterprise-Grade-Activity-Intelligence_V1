...
export const currentEmployee: T.EmployeeProfile = {
  ...
  joinDate: '2023-03-15',
  currentProject: 'WorkSphere Enterprise Platform',
  ...
  status: 'online',
  workHistory: [
    { id: 'wh-1', role: 'Senior Software Engineer', department: 'Engineering', project: 'WorkSphere Enterprise Platform', from: getLiveDate(-23), to: null, description: 'Leading frontend architecture for the next-gen HRMS dashboard. Implemented real-time analytics, RBAC, and work delegation systems.' },
...
export const leaveHistory: T.LeaveRequest[] = [
  { id: 'lv-1', employeeId: 'emp-100', employeeName: 'Gagan Chaudhary', type: 'annual', dayType: 'full', from: getLiveDate(-28), to: getLiveDate(-21), totalDays: 4, reason: 'Family vacation — summer break', status: 'approved', appliedDate: getLiveDate(-14), backupEmployeeId: 'emp-101', backupEmployeeName: 'Arjun Patel', attachments: [], managerComments: 'Approved. Enjoy your vacation!', isEmergency: false, delegations: [
    { id: 'del-1', taskId: 'task-102', taskTitle: 'Frontend Component Refactoring', project: 'WorkSphere Core', delegatedTo: 'emp-101', delegatedToName: 'Arjun Patel', status: 'accepted', skillMatch: 85, workloadImpact: 12 },
    { id: 'del-2', taskId: 'task-105', taskTitle: 'Code Review Backlog', project: 'WorkSphere Core', delegatedTo: 'emp-105', delegatedToName: 'Rohit Desai', status: 'accepted', skillMatch: 78, workloadImpact: 8 },
  ]},
...
export const tasks: T.Task[] = [
  ...
  { id: 'task-105', title: 'Code Review Backlog', description: 'Review and approve pending PRs from junior engineers.', project: 'WorkSphere Core', projectColor: '#3b82f6', status: 'todo', priority: 'low', assignee: 'emp-100', assigneeName: 'Gagan Chaudhary', reporter: 'emp-011', reporterName: 'Ananya Sharma', labels: ['review'], deadline: getLiveDate(18), createdAt: getLiveDate(25), updatedAt: getLiveDate(-29), progress: 0, storyPoints: 3, subtasks: [], comments: [], attachments: [], sprintId: 'sprint-8' },
