  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col h-full space-y-6">
      <div className="flex items-center justify-between shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-200">Attendance & Leave Operations</h1>
        ...
        <div className="lg:col-span-2 space-y-6 flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-4 shrink-0">
            <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-2xl">
              ...
              <div className="text-3xl font-bold text-slate-200">1,180 <span className="text-sm text-[#8b949e] font-normal">/ 1,248</span></div>
            </div>
            <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-2xl">
            ...
            <div className="bg-[#161b22] border border-[#30363d] p-4 rounded-2xl">
              ...
              <div className="text-3xl font-bold text-slate-200">26</div>
            </div>
          </div>
            ...
            {PENDING_LEAVES.map(req => (
              <div key={req.id} className="bg-[#0E1117] border border-[#30363d] rounded-xl p-4 flex flex-col gap-3">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="text-sm font-bold text-slate-200">{req.emp}</div>
