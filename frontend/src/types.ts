export type Role = 'CEO' | 'CTO' | 'HR' | 'HR_MANAGER' | 'HR_EXECUTIVE' | 'Manager' | 'MANAGER' | 'Lead' | 'LEAD' | 'Employee' | 'EMPLOYEE' | 'TECH_LEAD' | 'Marketing' | 'MARKETING' | 'MARKETING_MANAGER' | 'ADMIN' | 'SUPERADMIN' | 'SUPER_ADMIN' | 'IT' | 'SUPPORT' | 'SUPPORT_AGENT' | 'STAFF' | 'INTERN' | 'Intern' | 'FINANCE_MANAGER' | 'SALES_MANAGER' | 'PROJECT_MANAGER' | 'DEVOPS_ENGINEER' | 'QA_ENGINEER' | 'SOFTWARE_ENGINEER' | 'SECURITY_ANALYST'
