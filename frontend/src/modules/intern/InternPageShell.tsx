...
interface InternPageShellProps {
  title: string;
  description: string;
...
const InternPageShell: React.FC<InternPageShellProps> = ({ title, description, children, breadcrumbs, actions }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
        <Link to="/intern/dashboard" className="hover:text-blue-500 transition-colors">
...
export default InternPageShell;
