...
const TODAY_MEETINGS = [
  { id: 1, title: 'Final Interview: Alice Chen', time: '10:00 AM - 11:00 AM', attendees: 3, active: false, link: 'meet.enterprise.com/interview-ac' },
  { id: 2, title: 'HR Sync: Policy Rollout', time: '1:00 PM - 2:00 PM', attendees: 12, active: true, link: 'meet.enterprise.com/hr-sync' },
  { id: 3, title: 'Disciplinary Review: CONFIDENTIAL', time: '3:30 PM - 4:00 PM', attendees: 4, active: false, link: 'meet.enterprise.com/review-conf' },
];

export const HrMeetingsPage: React.FC = () => {
  return (
    <motion.div 
    ...
    >
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100 tracking-tight flex items-center gap-2">
            <Video className="w-6 h-6 text-indigo-500" /> Meetings & Schedules
          </h1>
          <p className="text-sm text-[#8b949e] mt-1">Manage interviews, HR syncing, and confidential meetings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
        ...
        {/* Active Meeting View */}
        <div className="lg:col-span-2 bg-[#0E1117] border border-[#30363d] rounded-xl flex flex-col overflow-hidden relative shadow-lg shadow-black/20">
          ...
          <div className="absolute top-4 left-4 z-10 bg-[#000000]/60 backdrop-blur-md px-3 py-1.5 rounded border border-white/10 flex items-center gap-2">
            ...
            <span className="text-xs text-white/70 ml-2">14:05</span>
          </div>
          ...
          <div className="flex-1 bg-[#090b10] flex items-center justify-center relative overflow-hidden">
             ...
             <div className="absolute inset-4 grid grid-cols-2 grid-rows-2 gap-4">
               ...
               <div className="bg-[#161b22] rounded-xl border border-indigo-500/50 flex items-center justify-center relative overflow-hidden ring-1 ring-indigo-500/50">
                 ...
                 <div className="absolute top-2 right-2 p-1 bg-black/60 rounded text-emerald-500">
               ...
               <div className="bg-[#21262d] rounded-xl border border-[#30363d] flex items-center justify-center relative overflow-hidden">
                 <span className="text-sm font-bold text-slate-400">+8 Others</span>
               </div>
             </div>
          </div>
