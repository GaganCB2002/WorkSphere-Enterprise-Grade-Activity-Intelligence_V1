  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-200">HR Operations Overview</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="bg-[#161b22] border border-[#30363d] p-5 rounded-2xl flex flex-col justify-between hover:border-slate-500 transition-colors">
            ...
            <div>
              <div className="text-3xl font-bold text-slate-900 dark:text-slate-200 mb-1">{stat.value}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-[#161b22] border border-[#30363d] rounded-2xl p-6">
          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-200 mb-4">Smart HR Alerts</h3>
