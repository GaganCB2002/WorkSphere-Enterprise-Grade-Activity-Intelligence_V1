  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-200">Performance Matrix</h1>
              ...
              {[
                ...
                <div key={i} className="bg-[#0E1117] border border-[#30363d] p-4 rounded-xl">
                  <div className="flex justify-between items-start mb-3">
                    <div className="text-sm font-bold text-slate-900 dark:text-slate-200">{okr.obj}</div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-[#161b22] border border-[#30363d] rounded-2xl p-6">
            ...
            <div className="bg-[#0E1117] border border-[#30363d] rounded-xl p-4 flex flex-col items-center justify-center text-center space-y-3">
              ...
              <div>
                <div className="text-sm font-bold text-slate-900 dark:text-slate-200">Q2 Performance Review</div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex justify-between items-center bg-[#0E1117] border border-[#30363d] p-3 rounded-xl">
                  <div>
                    <div className="text-xs font-bold text-slate-900 dark:text-slate-200">{emp.name}</div>
