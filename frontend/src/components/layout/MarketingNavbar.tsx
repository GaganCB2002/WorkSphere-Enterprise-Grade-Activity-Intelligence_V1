      ...
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
        ...
        >
          <div className="relative h-12 w-12 flex items-center justify-center group-hover:scale-110 transition-transform duration-500 cursor-pointer">
           ...
           <span className="text-2xl font-display font-black tracking-tighter uppercase text-[#172B4D] dark:text-white transition-colors ml-2">Work<span className="text-[#0052CC]">Sphere</span></span>
        </motion.div>
