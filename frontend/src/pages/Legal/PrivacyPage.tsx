...
export function PrivacyPage() {
  ...
  const sections = [
    ...
    },
    {
      title: "Data Usage",
      icon: FileText,
      content: "Your data is used solely to provide and improve WorkSphere services. This includes authentication, personalized dashboard telemetry, and critical system notifications. We never sell your personal information to third parties."
    },
    {
